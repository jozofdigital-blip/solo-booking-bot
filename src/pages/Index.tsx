  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <header className="container mx-auto px-4 py-4 sticky top-0 z-50 bg-background/95 backdrop-blur-md border-b">
        <div className="flex justify-between items-center max-w-7xl mx-auto">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl md:text-2xl font-bold bg-gradient-to-r from-telegram to-telegram/70 bg-clip-text text-transparent">
              LookTime
            </h2>
          </div>
          ...
          <nav className="hidden lg:flex items-center gap-6 xl:gap-10">
            <button
              ...
              className="text-foreground hover:text-telegram transition-colors font-medium"
            >
              Преимущества
            </button>
            <button
      ...
      <section className="container mx-auto px-4 py-8 md:py-16">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-muted-foreground mb-10 max-w-3xl mx-auto leading-relaxed">
            Увеличьте количество записей, принимая заявки <span className="font-semibold text-foreground">24/7</span> и
            НЕ теряйте клиентов с помощью автоматических напоминаний о визитах.
          </p>
              ...
              <div className="relative w-full h-full bg-background rounded-[2.5rem] overflow-hidden">
                ...
                <div
                  className={`absolute inset-0 transition-all duration-700 ${
                    activeScreen === "owner" ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-full"
                  }`}
                >
                ...
                <div
                  className={`absolute inset-0 transition-all duration-700 ${
                    activeScreen === "client" ? "opacity-100 translate-x-0" : "opacity-0 translate-x-full"
                  }`}
                >
      ...
      <section className="container mx-auto px-4 py-8 md:py-12">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">
            Если вы искали сервис для ведения <br className="hidden md:block" />и онлайн-записи клиентов, но:
          </h2>
      ...
      <section className="container mx-auto px-4 py-8">
        <div className="max-w-3xl mx-auto">
          <div className="bg-gradient-to-br from-telegram/10 to-telegram/5 rounded-3xl p-8 md:p-12 border border-telegram/20 text-center">
            ...
            <h3 className="text-2xl md:text-3xl font-bold mb-4">Вступайте в телеграм канал</h3>
      ...
      <section id="features" className="container mx-auto px-4 py-8 md:py-12 scroll-mt-20">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">Преимущества</h2>
      ...
      <section id="for-whom" className="container mx-auto px-4 py-8 md:py-12 scroll-mt-20">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">Для кого</h2>
          <div className="bg-gradient-to-br from-telegram/5 to-background p-8 md:p-12 rounded-3xl border border-telegram/20">
            ...
            <h3 className="text-2xl md:text-3xl font-bold mb-6 text-center">Любые частные исполнители</h3>
      ...
      <section id="pricing" className="container mx-auto px-4 py-8 md:py-12 scroll-mt-20">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-lg text-center text-muted-foreground mb-8">Честные тарифы без скрытых платежей</p>
            ...
            {[
              ...
              >
                ...
                <Button
                  onClick={() => window.open(TELEGRAM_CHANNEL, "_blank")}
                  className={
                    plan.popular ? "w-full bg-telegram hover:bg-telegram/90 h-10 md:h-11" : "w-full h-10 md:h-11"
                  }
          ...
          <div className="text-center bg-gradient-to-br from-warning/10 to-warning/5 p-6 md:p-8 rounded-2xl md:rounded-3xl border border-warning/20">
            ...
            <h3 className="text-lg md:text-xl font-bold mb-2 md:mb-3">Получите промокод на дополнительную скидку</h3>
            <p className="text-sm md:text-base text-muted-foreground mb-4 md:mb-6">В нашем телеграм-канале</p>
            <Button
              size="lg"
              onClick={() => window.open(TELEGRAM_CHANNEL, "_blank")}
              className="bg-telegram hover:bg-telegram/90 gap-2"
      ...
      <section className="container mx-auto px-4 py-8 md:py-12">
        <div className="max-w-3xl mx-auto text-center bg-gradient-to-br from-telegram to-telegram/80 rounded-2xl md:rounded-3xl p-8 md:p-16 border border-telegram/20 shadow-2xl text-white">
          ...
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-3 md:mb-4">Готовы начать?</h2>
          ...
          <p className="mt-4 md:mt-6 text-xs md:text-sm text-white/80">Бесплатный пробный период 10 дней</p>
        </div>
      </section>
